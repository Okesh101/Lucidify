...
const Navbar = () => {
    ...
    // bg-[#013272]
  return (
    <nav className="flex items-center justify-between px-6 py-4 bg-white shadow-[#061e3b] shadow-sm fixed top-0 left-0 right-0 z-50">
        ...
        <div className="flex gap-4 font-[ClashDisplay] tracking-wider" onClick={() => navigate('/authentication')}>
