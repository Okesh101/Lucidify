...
# def verify_company(RC_number):
#     data = loadJSON()
#     if data.get("status") != "OK":
#         return data
#     list_of_companies = data['data']['companies']
#     if RC_number not in list_of_companies:
#         return {"status": "ERROR",
#                 "code": 404,
...
#     business_data = company_data['data'][RC_number]
...
# def verify_business_name(BN_number):
#     data = loadJSON()
#     if data.get("status") != "OK":
#         return data
#     list_of_businesses = data['data']['business_names']
#     if BN_number not in list_of_businesses:
#         return {"status": "ERROR",
#                 "code": 404,
...
#     business_name_data = business_data['data'][BN_number]

#     business_name = business_name_data["business_name"]
#     business_nature = business_name_data["general_nature"]
#     # registration_date = business_name_data["registration_date"]
...
#                 "registered_address": registered_address
#             },
#             "message": "Business verified and details retrieved successfully."}
